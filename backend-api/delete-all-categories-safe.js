...
async function deleteAllCategoriesSafe() {
  try {
    ...
    try {
      ...
      await client.query('ALTER TABLE transactions DROP CONSTRAINT IF EXISTS transactions_category_id_fkey');
      console.log('   ✅ Dropped transactions_category_id_fkey constraint');
      
      await client.query('ALTER TABLE budgets DROP CONSTRAINT IF EXISTS budgets_category_id_fkey');
      console.log('   ✅ Dropped budgets_category_id_fkey constraint');
    ...
    console.log('4. After creating new categories, we can recreate the constraints');
